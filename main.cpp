...
void run(int argc, const char* argv[]) {
    ...
    auto unload_queue_work = [&] {
        logger::log(__LINE__, __FILE__, "🗑️ running detached thread for unload_queue_work 🚚...🚚...🚚...🚚...🚚, ie. 🥡 and then? 🥡 and then? 🥡 and then? 🥡 and then? 🥡 and then? 🥡 and then? 🥡 and then? 🥡 and then? ... 🥡 and then? 🥢 🥠 🥮");
        for (;;) {
